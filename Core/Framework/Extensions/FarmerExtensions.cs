...
public static class FarmerExtensions
{
    ...
    public static bool IsBurning(this Farmer farmer)
    {
    ...
    /// <param name="farmer">The <see cref="Farmer"/>.</param>
    public static void Unburn(this Farmer farmer)
    {
    ...
    public static bool IsFrozen(this Farmer farmer)
    {
    ...
    /// <param name="farmer">The <see cref="Farmer"/>.</param>
    public static void Defrost(this Farmer farmer)
    {
    ...
    public static bool IsJinxed(this Farmer farmer)
    {
