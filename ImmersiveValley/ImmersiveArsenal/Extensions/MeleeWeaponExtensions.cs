...
public static class MeleeWeaponExtensions
{
    ...
    internal static float DefaultCritPower(this MeleeWeapon weapon)
    {
        return weapon.type.Value switch
        {
            MeleeWeapon.defenseSword or MeleeWeapon.stabbingSword => 3f,
            MeleeWeapon.dagger => 3f,
            MeleeWeapon.club => 3f,
            _ => 0f,
        };
    }
    ...
    internal static ComboHitStep GetMaxComboHitCount(this MeleeWeapon weapon)
    {
        return weapon.type.Value switch
        {
