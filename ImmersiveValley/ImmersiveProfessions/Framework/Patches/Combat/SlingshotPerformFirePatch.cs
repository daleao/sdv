...
internal sealed class SlingshotPerformFirePatch : HarmonyPatch
{
    ...
    internal SlingshotPerformFirePatch()
    {
        ...
        this.Prefix!.after = new[] { "DaLion.ImmersiveSlingshots" };
    }
        ...
        Slingshot __instance, ref bool ___canPlaySound, GameLocation location, Farmer who)
    {
        try
        {
            ...
            var hasPreservingEnchantment = __instance.enchantments.FirstOrDefault(e =>
                e.GetType().FullName?.ContainsAllOf("ImmersiveSlingshots", "PreservingEnchantment") ==
                true) is not null;
            ...
            var primaryCollisionSound = string.Empty;
            ...
            var projectile = new ImmersiveProjectile(
                ...
                y,
                startingPosition,
                primaryCollisionSound,
                ammo is null ? "debuffSpell" : string.Empty,
                false,
                true,
                location,
                who,
                ammo is not null,
                primaryCollisionBehavior)
            {
            ...
            if (who.IsLocalPlayer && who.Get_Ultimate() is DeathBlossom { IsActive: true })
            {
                ...
                for (var i = 0; i < 7; ++i)
                {
                    ...
                    var petal = new ImmersiveProjectile(
                        __instance,
                        1f,
                        false,
                        (int)damage,
