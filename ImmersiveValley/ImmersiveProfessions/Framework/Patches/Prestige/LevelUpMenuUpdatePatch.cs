...
[UsedImplicitly]
internal sealed class LevelUpMenuUpdatePatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="LevelUpMenuUpdatePatch"/> class.</summary>
        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(
                        OpCodes.Call,
                        typeof(LevelUpMenuUpdatePatch).RequireMethod(nameof(ShouldSuppressClick))),
    ...
    private static void ProposeFinalQuestion(int chosenProfession, bool shouldCongratulateFullSkillMastery)
    {
        ...
        Game1.currentLocation.createQuestionDialogue(
            ModEntry.i18n.Get(
                ...
                {
                    pronoun,
                    oldProfession = oldProfession.DisplayName,
                    oldUltimate = Ultimate.FromValue(oldProfession).DisplayName,
                    newProfession = newProfession.DisplayName,
