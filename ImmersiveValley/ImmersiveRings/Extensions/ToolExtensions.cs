...
public static class ToolExtensions
{
    ...
    /// </returns>
    public static bool HasEnchantmentOfType(this Tool tool, Gemstone gemstone)
    {
    ...
    /// </returns>
    public static bool HasEnchantmentOfType<TGemstone>(this Tool tool)
    ...
    public static int CountEnchantmentsOfType(this Tool tool, Gemstone gemstone)
    {
        return tool.enchantments.OfType<BaseWeaponEnchantment>()
    ...
    public static int CountEnchantmentsOfType<TGemstone>(this Tool tool)
        where TGemstone : Gemstone
    {
        var gemstone = Gemstone.FromType(typeof(TGemstone));
        if (gemstone is null)
