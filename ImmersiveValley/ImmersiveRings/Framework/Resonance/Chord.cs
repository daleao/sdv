...
public sealed class Chord : IChord
{
    ...
    internal IGrouping<Gemstone, HarmonicInterval>[] GroupedIntervals { get; private set; } = null!;
    ...
    {
        ModEntry.State.ResonatingChords.Add(this);
    ...
    {
        ModEntry.State.ResonatingChords.Remove(this);
