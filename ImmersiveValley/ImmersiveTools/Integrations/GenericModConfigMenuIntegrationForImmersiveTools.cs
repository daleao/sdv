...
internal class GenericModConfigMenuIntegrationForImmersiveTools
{
    ...
    /// <summary>Initializes a new instance of the <see cref="GenericModConfigMenuIntegrationForImmersiveTools"/> class.</summary>
    /// <param name="modRegistry">API for fetching metadata about loaded mods.</param>
    /// <param name="manifest">The mod manifest.</param>
    /// <param name="getConfig">Get the current config model.</param>
    /// <param name="reset">Reset the config model to the default values.</param>
    /// <param name="saveAndApply">Save and apply the current config model.</param>
    public GenericModConfigMenuIntegrationForImmersiveTools(
        IModRegistry modRegistry,
        IManifest manifest,
        Func<ToolConfig> getConfig,
        Action reset,
        Action saveAndApply)
    {
        this._configMenu =
            new GenericModConfigMenuIntegration<ToolConfig>(modRegistry, manifest, getConfig, reset, saveAndApply);
    }
    ...
    public void Register()
    {
        ...
        this._configMenu
            ...
            .AddCheckbox(
                ...
                (config, value) =>
                {
                    ...
                    if (value)
                    {
                        ModEntry.Events.EnableForAllScreens<ToolButtonPressedEvent>();
                    }
                    else
                    {
                        ModEntry.Events.DisableForAllScreens<ToolButtonPressedEvent>();
                    }
                })
        ...
        this._configMenu
            .AddNumberField(
                ...
                (config, value) => config.AxeConfig.RadiusAtEachPowerLevel[ModEntry.IsMoonMisadventuresLoaded ? 6 : 4] =
                    value,
                1,
                10)
            .AddCheckbox(
        ...
        this._configMenu
            .AddNumberField(
                ...
                (config, value) =>
                    config.PickaxeConfig.RadiusAtEachPowerLevel[ModEntry.IsMoonMisadventuresLoaded ? 6 : 4] = value,
                1,
                10)
            .AddCheckbox(
