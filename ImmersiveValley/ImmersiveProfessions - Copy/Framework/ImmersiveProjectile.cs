...
internal class ImmersiveProjectile : BasicProjectile
{
    ...
    public override void behaviorOnCollisionWithMonster(NPC n, GameLocation location)
    {
        ...
        if (firer.IsLocalPlayer && ModEntry.Player.RegisteredUltimate is DeathBlossom { IsActive: false })
            ModEntry.Player.RegisteredUltimate.ChargeValue +=
                (DidBounce ? 18 : 12) - 10 * firer.health / firer.maxHealth;
    }
