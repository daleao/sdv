                ...
                case "dogStatue_changeUlt":
                    {
                        var currentProfessionKey =
                            ModEntry.Player.RegisteredUltimate!.Index.ToString().SplitCamelCase()[0].ToLowerInvariant();
...
#pragma warning restore CS8509
                            ...
                            ModEntry.Player.UsedDogStatueToday = true;
                ...
                default:
                    {
                        ...
                        if (Skill.TryFromName(skillName, true, out var skill))
                        {
                            if (questionAndAnswer.Contains("skillReset_"))
                            {
                                ...
                                ModEntry.Player.SkillsToReset.Enqueue(skill);
                        ...
                        else if (ModEntry.CustomSkills.TryGetValue(skillName, out var customSkill))
                        {
                            if (questionAndAnswer.Contains("skillReset_"))
                            {
                                ...
                                // prepare to prestige at night
                                ModEntry.Player.SkillsToReset.Enqueue(customSkill);
                                ModEntry.EventManager.Hook<PrestigeDayEndingEvent>();
