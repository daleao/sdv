...
internal sealed class GameLocationExplodePatch : DaLion.Common.Harmony.HarmonyPatch
{
        ...
        Farmer? who)
    {
        ...
        if (distanceFromEpicenter < radius * 2 + 1) ModEntry.Player.DemolitionistExcitedness = 4;
        if (distanceFromEpicenter < radius + 1) ModEntry.Player.DemolitionistExcitedness += 2;
