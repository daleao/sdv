...
public static class FarmerExtensions
{
    ...
    public static bool CanResetSkill(this Farmer farmer, ISkill skill)
    {
        ...
        var alreadyResetThisSkill = ModEntry.Player.SkillsToReset.Contains(skill);
    ...
    public static IEnumerable<UltimateIndex> GetUnchosenUltimates(this Farmer farmer) =>
        farmer.professions.Where(p => Enum.IsDefined(typeof(UltimateIndex), p)).Cast<UltimateIndex>()
            .Except(new[] { ModEntry.Player.RegisteredUltimate!.Index, UltimateIndex.None });
    ...
    /// <summary>Whether this farmer is currently in a fake farmer used for Piper Ultimate.</summary>
    public static bool IsFakeFarmer(this Farmer farmer) =>
        ModEntry.Host.FakeFarmers.ContainsKey(farmer.UniqueMultiplayerID);
}