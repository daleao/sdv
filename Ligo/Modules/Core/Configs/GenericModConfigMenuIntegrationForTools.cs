...
internal sealed partial class GenericModConfigMenuIntegration
{
    ...
    private void RegisterTools()
    {
        ...
        this._configMenu
            .AddPage(LigoModule.Tools.Namespace, () => "Tool Settings")
            ...
            // page links
            .AddPageLink(LigoModule.Tools + "/Axe", () => "Axe Settings", () => "Go to Axe settings.")
        ...
        this._configMenu
            .AddNumberField(
                ...
                config => (int)config.Tools.Axe.RadiusAtEachPowerLevel[Integrations.UsingMoodMisadventures ? 6 : 4],
            ...
            // pickaxe settings
            .AddPage(LigoModule.Tools + "/Pick", () => "Pick Settings")
            .AddPageLink(LigoModule.Tools.Namespace, () => "Back to Tool settings")
            .AddCheckbox(
        ...
        this._configMenu
            .AddNumberField(
                ...
                config => (int)config.Tools.Axe.RadiusAtEachPowerLevel[Integrations.UsingMoodMisadventures ? 6 : 4],
                (config, value) =>
                    config.Tools.Pick.RadiusAtEachPowerLevel[Integrations.UsingMoodMisadventures ? 6 : 4] = (uint)value,
                1,
                10)
            .AddCheckbox(
            ...
            // hoe settings
            .AddPage(LigoModule.Tools + "/Hoe", () => "Hoe Settings")
            .AddPageLink(LigoModule.Tools.Namespace, () => "Back to Tool settings")
            .AddCheckbox(
        ...
        this._configMenu
            ...
            // can settings
            .AddPage(LigoModule.Tools + "/Can", () => "Watering Can Settings")
            .AddPageLink(LigoModule.Tools.Namespace, () => "Back to Tool settings")
            .AddCheckbox(
                () => "Override Affected Tiles",
                () =>
