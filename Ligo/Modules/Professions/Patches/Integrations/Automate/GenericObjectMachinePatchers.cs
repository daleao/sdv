...
internal sealed class GenericObjectMachinePatchers : HarmonyPatcher
{
    ...
    {
        this.Transpiler!.after = new[] { LigoModule.Tweex.Namespace };
    }
    ...
    [HarmonyTranspiler]
    [HarmonyAfter("Ligo.Modules.Tweex")]
        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(
                        OpCodes.Call,
                        typeof(GenericObjectMachinePatchers).RequireMethod(nameof(ApplyArtisanPerks))));
        }
        catch (Exception ex)
        {
