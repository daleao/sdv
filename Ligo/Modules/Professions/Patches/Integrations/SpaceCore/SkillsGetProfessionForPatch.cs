...
internal sealed class SkillsGetProfessionForPatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="SkillsGetProfessionForPatch"/> class.</summary>
    internal SkillsGetProfessionForPatch()
    {
