...
To consume the API, copy both interfaces from the [Shared.Integrations.Ligo](../../../Shared/Integrations/Ligo) folder to your project and [ask SMAPI for a proxy][wiki:integrations-api].
