...
using DaLion.Ligo.Modules.Professions.Events.Input;
using DaLion.Ligo.Modules.Professions.Events.Player;
...
internal static class EventManagerExtensions
{
    ...
    private static readonly IReadOnlyDictionary<Profession, List<Type>> EventsByProfession = new Dictionary<Profession, List<Type>>()
    {
        ...
        { Profession.Rascal, new List<Type> { typeof(RascalButtonPressedEvent) } },
