...
{
    private static readonly BiMap<SCSkill, SpaceCore.Skills.Skill> LigoToSpaceCore = new();
    ...
    internal SCSkill(string id)
    {
        ...
        LigoToSpaceCore.TryAdd(this, skill);
    }
    ...
    {
        return LigoToSpaceCore.TryGetReverse(skill, out var scProfession) ? scProfession : null;
    }
    ...
    {
        return LigoToSpaceCore.TryGetForward(this, out var skill) ? skill : null;
    }
    ...
    public void ForgetRecipes(bool saveForRecovery = true)
    {
        ...
        var cookingRecipes = Ligo.Integrations.CookingSkillApi!
