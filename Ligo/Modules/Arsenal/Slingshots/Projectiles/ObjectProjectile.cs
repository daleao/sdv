namespace DaLion.Ligo.Modules.Arsenal.Slingshots.Projectiles;
...
internal sealed class ObjectProjectile : BasicProjectile
{
            ...
            ammo.ParentSheetIndex == Constants.ExplosiveAmmoIndex ? explodeOnImpact : null)
    {
        ...
        if (firer.professions.Contains(Farmer.scout) && !this.IsSquishy() && ModEntry.Config.Professions.ModKey.IsDown() && !source.CanAutoFire())
        {
