...
[UsedImplicitly]
internal sealed class ClickableMenuDrawHoverTextPatcher : HarmonyPatcher
{
    /// <summary>Initializes a new instance of the <see cref="ClickableMenuDrawHoverTextPatcher"/> class.</summary>
    internal ClickableMenuDrawHoverTextPatcher()
    {
        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(
                        OpCodes.Call,
                        typeof(ClickableMenuDrawHoverTextPatcher).RequireMethod(nameof(CompensateHeight))),
