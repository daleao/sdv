    ...
    public override bool CallbackImpl(string trigger, string[] args)
    {
        ...
        switch (args[0].ToLowerInvariant())
        {
            ...
            case "property":
                {
                    ...
                    var owedOverUnusedLand = (int)((agricultureValue + livestockValue) * (1f - usedPct) * Config.UnusedTileTaxRate);
            ...
            case "debt":
                ...
                this.Handler.Log.I($"Outstanding debt on {Game1.currentSeason} {Game1.dayOfMonth}, year {Game1.year}: {debt}g");
                break;

            default:
                this.Handler.Log.W("You must specify either \"income\" or \"property\" for the tax report type, or \"debt\" for outstanding liabilities.");
                return false;
        }
