...
internal static class WatcherFactory
{
    ...
    /// <summary>Creates a watcher which compares values using their <see cref="object.Equals(object)"/> method. This method should only be used when <see cref="ForEquatable{T}"/> won't work, since this doesn't validate whether they're comparable.</summary>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <param name="name">A name which identifies what the watcher is watching, used for troubleshooting.</param>
    /// <param name="getValue">Get the current value.</param>
    /// <returns>An interface for a new instance of <see cref="ComparableValueWatcher{TValue}"/>.</returns>
    ...
    /// <summary>Creates a watcher which detects when an object reference changes.</summary>
    /// <typeparam name="TValue">The value type.</typeparam>
    /// <param name="name">A name which identifies what the watcher is watching, used for troubleshooting.</param>
    /// <param name="getValue">Get the current value.</param>
    /// <returns>An interface for a new instance of <see cref="ComparableValueWatcher{TValue}"/>.</returns>
