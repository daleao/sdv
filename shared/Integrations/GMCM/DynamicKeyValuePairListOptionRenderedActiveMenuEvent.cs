...
[UsedImplicitly]
internal sealed class DynamicKeyValuePairListOptionRenderedActiveMenuEvent : RenderedActiveMenuEvent
{
    ...
    internal DynamicKeyValuePairListOptionRenderedActiveMenuEvent(EventManager manager)
        : base(manager)
    {
    }
