...
public static class Vector2Extensions
{
    ...
    /// <param name="boundary">An optional boundary condition.</param>
    /// <returns>The list of <see cref="Vector2"/>s belonging to the enclosed region.</returns>
    public static IReadOnlyList<Vector2> FloodFill(this Vector2 origin, int width, int height, Func<Vector2, bool>? boundary = null)
    {
        boundary ??= _ => true;
