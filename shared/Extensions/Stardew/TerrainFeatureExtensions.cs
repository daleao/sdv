...
public static class TerrainFeatureExtensions
{
    ...
    {
        return (terrainFeature.currentTileLocation - tile).Length();
    }
    ...
    {
        return terrainFeature.DistanceTo(character.getTileLocation());
    }
    ...
    {
        return terrainFeature.DistanceTo(other.currentTileLocation);
    }
