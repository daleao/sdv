...
internal sealed class Reflector
{
    ...
    public Func<TInstance, TField> GetUnboundFieldGetter<TInstance, TField>(Type type, string name)
    {
    ...
    {
        return this.GetUnboundFieldGetter<TInstance, TField>(instance.GetType(), name);
    }
    ...
    /// <returns>A delegate for getting the field's value.</returns>
    public Func<TInstance, TField> GetUnboundFieldGetter<TInstance, TField>(string typeName, string fieldName)
    {
        return this.GetUnboundFieldGetter<TInstance, TField>(typeName.ToType(), fieldName);
    }
    ...
    public Func<TInstance, TField> GetUnboundFieldGetter<TInstance, TField>(string name)
    {
    ...
    public Action<TInstance, TField> GetUnboundFieldSetter<TInstance, TField>(Type type, string name)
    {
        return this.GetCachedDelegate(
            "fs",
            type,
    ...
    {
        return this.GetUnboundFieldSetter<TInstance, TField>(instance.GetType(), name);
    }
    ...
    /// <param name="fieldName">The field name.</param>
    /// <returns>A delegate for setting the field's value.</returns>
    public Action<TInstance, TField> GetUnboundFieldSetter<TInstance, TField>(string typeName, string fieldName)
    {
        return this.GetUnboundFieldSetter<TInstance, TField>(typeName.ToType(), fieldName);
    }
    ...
    /// <returns>A delegate for setting the field's value.</returns>
    /// <remarks>This overload requires that the target field be declared within the hierarchy of <typeparamref name="TInstance"/>.</remarks>
    public Action<TInstance, TField> GetUnboundFieldSetter<TInstance, TField>(string name)
    {
        var type = typeof(TInstance);
        return this.GetCachedDelegate(
            "fs",
    ...
    public Func<TInstance, TProperty> GetUnboundPropertyGetter<TInstance, TProperty>(Type type, string name)
    {
        return this.GetCachedDelegate(
            "pg",
            type,
    ...
    {
        return this.GetUnboundPropertyGetter<TInstance, TProperty>(instance.GetType(), name);
    }
    ...
    /// <returns>A delegate to the property getter.</returns>
    public Func<TInstance, TProperty> GetUnboundPropertyGetter<TInstance, TProperty>(string typeName, string propertyName)
    {
        return this.GetUnboundPropertyGetter<TInstance, TProperty>(typeName.ToType(), propertyName);
    }
    ...
    /// <returns>A delegate to the property getter.</returns>
    /// <remarks>This overload requires that the target field be declared within the hierarchy of <typeparamref name="TInstance"/>.</remarks>
    public Func<TInstance, TProperty> GetUnboundPropertyGetter<TInstance, TProperty>(string name)
    {
        var type = typeof(TInstance);
        return this.GetCachedDelegate(
            "pg",
    ...
    public Action<TInstance, TProperty> GetUnboundPropertySetter<TInstance, TProperty>(Type type, string name)
    {
        return this.GetCachedDelegate(
            "ps",
            type,
    ...
    {
        return this.GetUnboundPropertySetter<TInstance, TProperty>(instance.GetType(), name);
    }
    ...
    /// <param name="propertyName">The property name.</param>
    /// <returns>A delegate to the property setter.</returns>
    public Action<TInstance, TProperty> GetUnboundPropertySetter<TInstance, TProperty>(string typeName, string propertyName)
    {
        return this.GetUnboundPropertySetter<TInstance, TProperty>(typeName.ToType(), propertyName);
    }
    ...
    /// <returns>A delegate to the property setter.</returns>
    /// <remarks>This overload requires that the target field be declared within the hierarchy of <typeparamref name="TInstance"/>.</remarks>
    public Action<TInstance, TProperty> GetUnboundPropertySetter<TInstance, TProperty>(string name)
    {
        var type = typeof(TInstance);
        return this.GetCachedDelegate(
            "ps",
    ...
    public TDelegate GetUnboundMethodDelegate<TDelegate>(Type type, string name)
    ...
    public TDelegate GetUnboundMethodDelegate<TDelegate>(object instance, string name)
        where TDelegate : Delegate
    {
        return this.GetUnboundMethodDelegate<TDelegate>(instance.GetType(), name);
    }
    ...
    /// <returns>A delegate to the method.</returns>
    public TDelegate GetUnboundMethodDelegate<TDelegate>(string typeName, string methodName)
        where TDelegate : Delegate
    {
        return this.GetUnboundMethodDelegate<TDelegate>(typeName.ToType(), methodName);
    }
