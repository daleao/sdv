...
namespace TheLion.Stardew.Professions.Framework.Extensions
{
	public static class MineShaftExtensions
	{
		...
		{
			return (shaft.mineLevel <= 120 && shaft.mineLevel % 10 == 0) || (shaft.mineLevel == 220 && Game1.player.secretNotesSeen.Contains(10) && !Game1.player.mailReceived.Contains("qiCave")) || ModEntry.Reflection.GetField<NetBool>(shaft, name: "netIsTreasureRoom").GetValue().Value;
		}
	}
}