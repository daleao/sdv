...
Each project in the solution is a standalone mod focusing on a specific gameplay mechanic, introducing overhauls, new systems, or both.
...
4. Open `DaLion.Stardew.sln`, or `*.csproj` for the desired project.
5. Edit each `*.csproj`. Under `<!-- paths -->`, adjust the game path, mods path, and mod zip path to match your game install directory. Depending on your OS, this is usually one of the following:
