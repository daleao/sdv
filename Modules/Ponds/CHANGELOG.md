...
## 2.5.5 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>

### Fixed

* Fixes an issue with legendary fish not retaining quality. Apparently.

## 2.5.0 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>

### Added

* Mr. and Ms. Angler can now mate when placed together in a pond.

## 1.0.4 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>
...
## 1.0.2 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>
...
## 1.0.0 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>
...
## 0.9.6 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>
...
## 0.9.2 <sup><sup>[🔼 Back to top](#pnds-changelog)</sup></sup>
