...
[UsedImplicitly]
internal class RingOnEquipPatch : BasePatch
{
    /// <summary>Construct an instance.</summary>
    internal RingOnEquipPatch()
    {
        Original = RequireMethod<Ring>(nameof(Ring.onEquip));
    }
    ...
    [HarmonyPostfix]
    private static void RingOnEquipPostfix(Ring __instance, Farmer who)
    {
