namespace DaLion.Redux.Professions.Patches.Mining;
...
internal sealed class ObjectPlacementActionPatch : HarmonyPatch
{
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        // Injected: if (who is not null && who.professions.Contains(<demolitionist_id>) && ModEntry.SlingshotConfig.ModKey.IsDown()) skipIntensity ...
