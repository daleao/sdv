...
using DaLion.Redux.Professions.Patches.Prestige;
...
internal sealed class NewSkillsPageDrawPatch : HarmonyPatch
{
    ...
    internal NewSkillsPageDrawPatch()
    {
        this.Target = typeof(SpaceCore.Interface.NewSkillsPage)
            .RequireMethod(nameof(SpaceCore.Interface.NewSkillsPage.draw), new[] { typeof(SpriteBatch) });
    }
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        // Inject: x -= ModEntry.SlingshotConfig.PrestigeProgressionStyle == ProgressionStyle.Stars ? Textures.STARS_WIDTH_I : Textures.RIBBON_WIDTH_I;
        // After: x = ...
        try
        {
