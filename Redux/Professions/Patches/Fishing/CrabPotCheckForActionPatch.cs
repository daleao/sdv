...
[UsedImplicitly]
internal sealed class CrabPotCheckForActionPatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="CrabPotCheckForActionPatch"/> class.</summary>
