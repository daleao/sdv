...
[UsedImplicitly]
internal sealed class FarmerShowItemIntakePatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="FarmerShowItemIntakePatch"/> class.</summary>
