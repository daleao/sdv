...
using DaLion.Redux.Arsenal.Events;
    ...
    private void RegisterArsenal()
    {
        this._configMenu
            ...
            .AddCheckbox(
                ...
                (config, value) => config.Arsenal.OverhauledDefense = value)
            .AddCheckbox(
            ...
            .AddCheckbox(
                ...
                (config, value) =>
                {
                    ...
                    if (value)
                    {
                        Arsenal.Weapons.Utils.ConvertStabbySwords();
                    }
                    else
                    {
                        Arsenal.Weapons.Utils.RevertStabbySwords();
                    }
                })
            .AddCheckbox(
                () => "Combo Hits",
