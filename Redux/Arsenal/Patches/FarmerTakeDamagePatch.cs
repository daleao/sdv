...
internal sealed class FarmerTakeDamagePatch : HarmonyPatch
{
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        try
        {
            ...
            helper
                .FindNext(
                    new CodeInstruction(OpCodes.Call, typeof(Rumble).RequireMethod(nameof(Rumble.rumble))))
    ...
    {
        var resilience = farmer.resilience;
        if (farmer.CurrentTool is MeleeWeapon weapon)
        {
