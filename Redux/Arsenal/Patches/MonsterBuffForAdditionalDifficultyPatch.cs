namespace DaLion.Redux.Arsenal.Patches;
...
[UsedImplicitly]
internal sealed class MonsterBuffForAdditionalDifficultyPatch : HarmonyPatch
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="MonsterBuffForAdditionalDifficultyPatch"/> class.Construct and
    ///     instance.
    /// </summary>
