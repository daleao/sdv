...
public sealed class SpreadingEnchantment : BaseSlingshotEnchantment
{
    ...
    {
        var collisionSound = ModEntry.Reflector
                .GetUnboundFieldGetter<BasicProjectile, NetString>(projectile, "collisionSound")
                .Invoke(projectile);
        var collisionBehavior = ModEntry.Reflector
            .GetUnboundFieldGetter<BasicProjectile, BasicProjectile.onCollisionBehavior?>(projectile, "collisionBehavior")
            .Invoke(projectile);
