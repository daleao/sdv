...
internal sealed class ToolDrawTooltipPatch : HarmonyPatch
{
        ...
        StringBuilder? overrideText)
    {
        ...
        {
            var amount = $"+{__instance.GetEnchantmentLevel<RubyEnchantment>() * 0.1f:0%}";
        ...
        {
            var amount =
                $"+{__instance.GetEnchantmentLevel<JadeEnchantment>() * (ModEntry.Config.EnableArsenal && ModEntry.Config.Arsenal.RebalancedForges ? 0.5f : 0.1f):0%}";
            co = new Color(0, 120, 120);
            Utility.drawWithShadow(
                spriteBatch,
                Game1.mouseCursors,
        ...
        {
            var amount = $"+{__instance.GetEnchantmentLevel<EmeraldEnchantment>() * 0.1f:0%}";
            co = new Color(0, 120, 120);
            Utility.drawWithShadow(
                spriteBatch,
                Game1.mouseCursors,
        ...
        {
            var amount = $"+{__instance.GetEnchantmentLevel<GarnetEnchantment>() * 0.1f:0%}";
            co = new Color(0, 120, 120);
            Utility.drawWithShadow(
                spriteBatch,
                Game1.mouseCursors,
        ...
        {
            var amount = $"+{__instance.GetEnchantmentLevel<TopazEnchantment>() * 0.1f:0%}";
            co = new Color(0, 120, 120);
            Utility.drawWithShadow(
                spriteBatch,
                Game1.mouseCursors,
