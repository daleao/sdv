...
using DaLion.Redux.Framework.Ponds.Extensions;
...
[UsedImplicitly]
internal sealed class FishPondDayUpdatePatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="FishPondDayUpdatePatch"/> class.</summary>
