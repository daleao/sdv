        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(
                        OpCodes.Call,
                        typeof(Shared.Extensions.Stardew.SObjectExtensions).RequireMethod(nameof(Shared.Extensions.Stardew.SObjectExtensions.IsForagedMineral))),
                ...
                .ReplaceInstructionWith(
                    ...
                    new CodeInstruction(
                        OpCodes.Call,
                        typeof(Extensions.FarmerExtensions).RequireMethod(nameof(Extensions.FarmerExtensions.GetEcologistForageQuality))))
