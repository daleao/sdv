...
using System.Text;
using DaLion.Redux.Framework.Professions.Events.GameLoop.DayEnding;
using DaLion.Redux.Framework.Professions.Extensions;
using DaLion.Redux.Framework.Professions.Sounds;
...
internal sealed class GameLocationDamageMonsterPatch : HarmonyPatch
{
        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(OpCodes.Ldc_R4, Frenzy.PercentIncrementPerRage),
    ...
    private static void HandleBrute(Monster monster, Farmer who, Ultimate? ultimate)
    {
        ...
        ModEntry.State.Professions.SecondsOutOfCombat = 0;
        ...
        if (ultimate.IsActive)
        {
            ...
            ++ModEntry.State.Professions.BruteKillCounter;
        }
        else
        {
            // increment ultimate
    ...
    private static void HandlePoacher(bool didCrit, float critMultiplier, Monster monster, Farmer who, Ultimate? ultimate, Random r)
    {
        ...
        ultimate.ChargeValue += ultimate.MaxValue / 2d;
    ...
    private static void HandlePiper(Monster monster, Farmer who, Ultimate? ultimate, Random r)
    {
        ...
        {
            var applied = ModEntry.State.Professions.AppliedPiperBuffs;
