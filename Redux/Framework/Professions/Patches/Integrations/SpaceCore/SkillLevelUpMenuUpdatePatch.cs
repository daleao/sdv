...
internal sealed class SkillLevelUpMenuUpdatePatch : HarmonyPatch
{
    ...
    private static object? ChooseProfessionPair(object skillInstance, string skillId, int currentLevel)
    {
        ...
        var secondStringId = ModEntry.Reflector
            ...
            .Invoke(second);
        var firstId = Framework.Integrations.SpaceCoreApi!.GetProfessionId(skillId, firstStringId);
        var secondId = Framework.Integrations.SpaceCoreApi.GetProfessionId(skillId, secondStringId);
    ...
    {
        return SCProfession.LoadedProfessions.TryGetValue(hovered, out var profession) &&
