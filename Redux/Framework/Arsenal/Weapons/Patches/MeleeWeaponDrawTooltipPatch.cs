        ...
        MeleeWeapon __instance, SpriteBatch spriteBatch, ref int x, ref int y, SpriteFont font, float alpha)
    {
        ...
        Utility.drawTextWithShadow(
            ...
            Game1.content.LoadString(
                ...
                (int)(__instance.minDamage.Value * (1f + __instance.Read<float>(DataFields.ResonantWeaponDamage))),
                (int)(__instance.maxDamage.Value * (1f + __instance.Read<float>(DataFields.ResonantWeaponDamage)))),
            font,
        ...
        var crate = __instance.critChance.Value * (1f + __instance.Read<float>(DataFields.ResonantWeaponCritChance));
        ...
        var cpow = __instance.critMultiplier.Value * (1f + __instance.Read<float>(DataFields.ResonantWeaponCritPower));
        ...
        var knockback = __instance.knockback.Value * (1f + __instance.Read<float>(DataFields.ResonantWeaponKnockback));
        ...
        var speed = (__instance.speed.Value + __instance.Read<float>(DataFields.ResonantWeaponSpeed)) * 0.1f;
        if (speed != 0)
        {
        ...
        {
            var cdr =
                $"-{(__instance.GetEnchantmentLevel<GarnetEnchantment>() + __instance.Read<float>(DataFields.ResonantWeaponCooldownReduction)) * 0.1f:0%}";
            co = new Color(0, 120, 120);
            Utility.drawWithShadow(
                spriteBatch,
                Game1.mouseCursors,
        ...
        // write bonus defense
        var defense = (__instance.addedDefense.Value + __instance.Read<float>(DataFields.ResonantWeaponDefense)) * 0.1f;
