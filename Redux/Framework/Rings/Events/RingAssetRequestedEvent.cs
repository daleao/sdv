...
internal class RingAssetRequestedEvent : AssetRequestedEvent
{
        ...
        : base(manager)
    {
        ...
        AssetProviders[$"{ModEntry.Manifest.UniqueID}/Gemstones"] = (() =>
                "assets/sprites/gemstones" + (Framework.Integrations.IsBetterRingsLoaded ? "_bbr" : string.Empty) + ".png",
            Priority: AssetLoadPriority.Medium);
        AssetProviders[$"{ModEntry.Manifest.UniqueID}/Rings"] = (() =>
                "assets/sprites/rings" + (Framework.Integrations.IsBetterRingsLoaded ? "_bbr" : string.Empty) + ".png",
            Priority: AssetLoadPriority.Medium);
        AssetProviders[$"{ModEntry.Manifest.UniqueID}/ResonanceLight"] = (() =>
            "assets/lights/resonance", Priority: AssetLoadPriority.Medium);
