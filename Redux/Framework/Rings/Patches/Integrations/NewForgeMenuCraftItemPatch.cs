...
[UsedImplicitly]
internal sealed class NewForgeMenuCraftItemPatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="NewForgeMenuCraftItemPatch"/> class.</summary>
    internal NewForgeMenuCraftItemPatch()
    {
