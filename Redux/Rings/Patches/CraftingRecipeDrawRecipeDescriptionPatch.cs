...
[UsedImplicitly]
internal sealed class CraftingRecipeDrawRecipeDescriptionPatch : HarmonyPatch
{
    /// <summary>Initializes a new instance of the <see cref="CraftingRecipeDrawRecipeDescriptionPatch"/> class.</summary>
