...
internal sealed class CombinedRingDrawInMenuPatch : HarmonyPatch
{
        ...
        bool drawShadow)
    {
        ...
        try
        {
            ...
            offset = Redux.Integrations.IsBetterRingsLoaded ? new Vector2(19f, 3f) : new Vector2(24f, 12f);
            spriteBatch.Draw(
            ...
            if (count > 1)
            {
                ...
                offset = Redux.Integrations.IsBetterRingsLoaded ? new Vector2(23f, 19f) : new Vector2(24f, 44f);
                spriteBatch.Draw(
                    Textures.GemstonesTx,
                    location + (offset * scaleSize),
            ...
            if (count > 2)
            {
                ...
                offset = Redux.Integrations.IsBetterRingsLoaded ? new Vector2(35f, 7f) : new Vector2(8f, 28f);
                spriteBatch.Draw(
                    Textures.GemstonesTx,
                    location + (offset * scaleSize),
            ...
            if (count > 3)
            {
                ...
                offset = Redux.Integrations.IsBetterRingsLoaded ? new Vector2(39f, 23f) : new Vector2(40f, 28f);
                spriteBatch.Draw(
                    Textures.GemstonesTx,
                    location + (offset * scaleSize),
