...
internal sealed class BeeHouseMachineGetOutputPatch : HarmonyPatch
{
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        // Injected: if (ModEntry.SlingshotConfig.AgeImprovesBeeHouses) object.Quality = obj.GetQualityFromAge();
        // Before: StardewValley.Ammo result = obj;
        ...
        try
        {
            helper
                ...
                .InsertInstructions(
                    ...
                    new CodeInstruction(
                        OpCodes.Callvirt,
                        typeof(Config).RequirePropertyGetter(nameof(Config.AgeImprovesBeeHouses))),
