...
internal sealed class CoreAttemptPushToHopperPatcher : HarmonyPatcher
{
    /// <summary>Initializes a new instance of the <see cref="CoreAttemptPushToHopperPatcher"/> class.</summary>
    /// <param name="harmonizer">The <see cref="Harmonizer"/> instance that manages this patcher.</param>
    /// <param name="logger">A <see cref="Logger"/> instance.</param>
    internal CoreAttemptPushToHopperPatcher(Harmonizer harmonizer, Logger logger)
