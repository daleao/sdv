...
[spoiler][color=gold][img]https://i.imgur.com/akUNM3E.png[/img] [b]Master Forager (Lv15)[/b] - [s]20%[/s] → 40% chance for double yield of foraged items.[/color]
[spoiler][size=2]
Other than the name, changed for consistency with other skills, this profession is unchanged from vanilla.[/size][/spoiler]
[/spoiler]
[/*]
...
[spoiler][size=2]
The perk is unchanged from vanilla, but it is now attached to the "correct" profession name.[/size][/spoiler]
[/spoiler]
[/*]
...
[spoiler][color=gold][img]https://i.imgur.com/alCwQz0.png[/img] [b]Syrupwright (Lv20)[/b] - Tapped trees produce syrup [s]25%[/s] → 50% faster. Double yield from recipes that consume syrups.[/color]
[spoiler][size=2]
...
[spoiler][color=gold][img]https://i.imgur.com/7KgdhZR.png[/img] [b]Master Miner (Lv15)[/b] - [s]+1[/s] → +2 ore per ore vein.[/color]
[spoiler][size=2]
...
[spoiler][color=gold][img]https://i.imgur.com/FJCgEjI.png[/img] [b]Master Fisher (Lv15)[/b] - Baits are [s]2x[/s] → 3x more effective when fishing.[/color]
[spoiler][size=2]
...
[*][size=2][b]Magic bait:[/b] Catches [size=2]non-Crab Pot[/size] fish of any location or season.[/size][/*]
[*][size=2][b]Deluxe bait:[/b] Quality is boosted by one additional stage.[/size][/*]
[/list]
[size=2]
All baits, with the exception of Magnet, also prevent collecting junk.[/size][/spoiler]
[/spoiler]
[/*]
...
[spoiler][color=gold][img]https://i.imgur.com/CWig7vg.png[/img] [b]Master Fighter (Lv15)[/b] - Damage [s]+10%[/s] → +20%.[/color]
[spoiler][size=2]
Completely unchanged from vanilla.[/size][/spoiler]
[/spoiler]
[/*]
...
[spoiler][color=gold][img]https://i.imgur.com/pz38M5L.png[/img] [b]Saboteur (Lv20)[/b] - Enemies can be poached twice. Inflict deadly poison with each successful poach.[/color]
[spoiler][size=2]
...
[b]Deadly Poison:[/b] Deals tick damage every second. On second application causes instant-death.[/size][/spoiler]
[/spoiler]
[/*]
[*][img]https://i.imgur.com/B6HwzRC.png[/img] [b]Rascal (Lv5)[/b] - Gain one additional ammo slot. 35% chance to recover spent ammo.
[spoiler][color=gold][img]https://i.imgur.com/djcciFv.png[/img] [b]Master Rascal (Lv15)[/b] - [s]35%[/s] → 55% chance to recover spent ammo. Can fire both ammo slots at once.[/color]
[spoiler][size=2]
...
[/spoiler]
[/*]
[*][img]https://i.imgur.com/h7P2nZI.png[/img] [b]Desperado (Lv10)[/b] - Damage +50% from hip-fired shots that hit a new target within 0.8 seconds of the last. Can overcharge the slingshot.
[spoiler][color=gold][img]https://i.imgur.com/fSH1QEc.png[/img] [b]Deadeye (Lv20)[/b] - Hip-fired shots can ricochet. Double damage from rebound or pierced shots.[/color]
[spoiler][size=2]
...
[*][size=2]First-generation Slimes (hatched from eggs) are born with a random IV between 0 and 2.[/size][/*]
[*][size=2]IVs can be increased by [url=https://stardewvalleywiki.com/Slime_Hutch#Mating_Color_Results]breeding[/url]; when a baby Slime is born, it inherits the highest IVs from both parents, with a decent chance for an increase of 1 or 2 points, and a tiny chance for a decrease. This guarantees that IVs will converge to max after a few generations.[/size][/*]
[*][size=2]Baby Slime stats are inherited independently of color, so that Slimes of any color can be raised to max stats.[/size][/*]
...
[spoiler][size=2]
Charged by taking damage or defeating enemies. Charges more quickly if enemies are defeated using a blunt weapon.[/size][/spoiler]
[/*]
[*][img]https://i.imgur.com/WgSlFvA.png[/img] [b]Ambuscade (Bushwhacker)[/b] - Become invisible and untargetable for 30s. Attacking an enemy forfeits the invisibility, but crit. power is doubled for twice the leftover invisibility duration. If an enemy is slain within 0.5s of losing invisibility, immediately reactivates Ambuscade.
[spoiler][size=2]
Charged by scoring critical hits, and the charge amount is proportional to crit. power.[/size][/spoiler]
[/*]
[*][img]https://i.imgur.com/wc6J7DV.png[/img] [b]Death Blossom (Desperado)[/b] - For 15s, enable auto-fire and all shots fire in eight cardinal directions at once at no additional ammo cost.
[spoiler][size=2]
Journey of the Prairie King, "IRL". Charged by hitting monsters with projectiles. Charges more quickly when low on health.[/size][/spoiler]
[/*]
...
If using mods which add new Artisan Machines or Animal Goods such as different types of milk or cheese, you must add those items to this mod's data assets folder to make them compatible with Artisan and Producer professions. See instructions in the FAQ at the bottom of this page.

[b][size=3]Barn, Coop and Slime Hutch Mods[/size][/b]

Mods which edit the interior maps of Deluxe Barn and Coop or Slime Hutch will conflict, respectively, with Yieldmeister, Progenitor and Piper professions. This includes [url=https://www.nexusmods.com/stardewvalley/mods/31782]Monster Hutch Framework[/url].

Texture-only changes are fine. If you don't choose any of these professions then you have nothing to worry about.

[b][size=3]Multiplayer[/size][/b]

Yes, it should work in multiplayer.

[b][size=3]Android/Mobile[/size][/b]
...
[spoiler]Scroll back up to the Skill Reset section and make sure you have read the part where it says
[quote][b]once a skill has been Mastered it can no longer be reset[/b][/quote]
[/spoiler]
...
[/list]
[/*]
[*]Open your new asset file at [b]`DaLion.Professions/assets/data/xyz.ArtisanMachines.json`[/b].[/*]
...
As noted above, each mod may organize their files differently, so you may not find a specific file for each machine / item. Some authors may group all machines into a single `machines.json` file for example, and yet others may put everything inside CP's base `content.json` file.[/spoiler]
[b]Will you add even further progression beyond level 20?[/b]
[spoiler]This isn’t just a matter of raising or removing the level cap. If there’s nothing meaningful to gain from extra levels, there’s no point in adding them. Right now, level-ups give three types of benefits:
[list]
