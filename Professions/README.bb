...
[*][img]https://i.imgur.com/JAhCe85.png[/img] [b]Agriculturist (Lv10)[/b] - Rotate crops to enrich the soil, boosting growth speed and quality. Best-quality crops can be harvested organically, without fertilizers.
[spoiler][color=gold][img]https://i.imgur.com/YXpr4ZY.png[/img] [b]Cropwhisperer (Lv20)[/b] - Growth speed bonuses also apply to the regrowth phase of multi-harvest crops. Crops can survive up to one week out of season.[/color][size=2]
[spoiler]
[b]Crop rotation[/b] works as follows:
...
[b]Best-quality[/b] refers to iridium quality, which normally requires Deluxe Fertilizer. This does not affect the *chance* to obtain iridium quality in any way; it is always equal to half the chance of obtaining gold quality. Fertilizers are still very useful.
...
[spoiler][color=gold][img]https://i.imgur.com/Na7x4w0.png[/img] [b]Relicseeker (Lv20)[/b] - Time freezes during Scavenger Hunts. Find increasingly more forageables during a high Scavenger streak.[/color][size=2]
[spoiler]
...
[spoiler][color=gold][img]https://i.imgur.com/9DPJjPB.png[/img] [b]Rodmancer (Lv20)[/b] - Up to two tackle effects can linger on the fishing rod. Can re-encounter legendary fish.[/color][size=2]
[spoiler]
[list]
...
[*][img]https://i.imgur.com/XV5jQ3k.png[/img] [b]Slimed Piper | Siren (Lv10)[/b] - Summon raised Slimes to aid you in combat. Designate one Slime to carry items. Slime Hutch capacity +50%.
...
[*] If the profession is prestiged, certain Slime variants will gain unique special abilities: [color=#00aa00][b]Green:[/b] Causes Slimed debuff.[/color] [color=#0000aa][b]Blue:[/b] Causes Chilled/Frozen debuff.[/color] [color=#aa0000][b]Red/Purple:[/b] Causes Burn debuff.[/color] [color=#333333][b]Black:[/b] Causes Blindness debuff.[/color] [color=#eeeeee][b]White:[/b] Grants an aura that heals a low amount of health over time.[/color] [color=#ffc000][b]Gold:[/b] Causes nearby enemies to drop gold (100g per kill).[/color] [b]Prismatic:[/b] Causes nearby enemies to drop Prismatic Shards.
...
[*][b]Slime Mayo and Slime Cheese[/b], are added as well, to add a small amount of depth to Slime Ranching playstyle enabled by Slimed Piper profession. Credit for these items goes entirely to [url=https://next.nexusmods.com/profile/Tarniyar?gameId=1303]Tarniyar[/url], author of [url=https://www.nexusmods.com/stardewvalley/mods/6113]Garden Village[/url].
